...
<HEAD>
	...
	<META NAME="CHANGED" CONTENT="20200430;154300000000000">
...
21 марта 2016 г. N 113</B></FONT></FONT></FONT></P>
<P ALIGN=CENTER STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
...
ПОСТРОЕНИЮ СЕТИ СВЯЗИ ОБЩЕГО ПОЛЬЗОВАНИЯ
В ЧАСТИ СИСТЕМЫ<BR>ОБЕСПЕЧЕНИЯ ТАКТОВОЙ
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>Сеть
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>а) ПЭГ;</FONT></FONT></FONT></P>
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>б) ВЗГ,
при синхронизации от ПЭИ или от встроенного
...
ГЛОНАСС/GPS.</FONT></FONT></FONT></P>
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>6. При
возникновении аварийных ситуаций в
сети ТСС и пропадании входных сигналов
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>7. Сеть
ТСС должна использовать сигналы
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>8. При
наличии на узле связи ПЭГ, ПЭИ, ВЗГ, МЗГ
или БСС внутриузловая сеть ТСС должна
строиться по схеме &quot;звезда&quot;, при
которой основные сигналы синхронизации
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>9. Во
внутриузловой сети ТСС в качестве
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>11. Цепи
синхронизации образуются техническими
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>Требования
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>12. В
цепях синхронизации допускается
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>13. Сеть
ТСС должна получать сигналы синхронизации
от основного и резервных источников
синхронизации.</FONT></FONT></FONT></P>
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>14. При
распределении сигналов синхронизации
...
предотвращения образования петель
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>16. В
целях обеспечения целостности,
...
<P ALIGN=CENTER STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3><B>ОСНОВНЫЕ
ПОНЯТИЯ,<BR>ИСПОЛЬЗУЕМЫЕ В ТРЕБОВАНИЯХ
К ПОСТРОЕНИЮ СЕТИ СВЯЗИ ОБЩЕГО<BR>ПОЛЬЗОВАНИЯ
В ЧАСТИ СИСТЕМЫ ОБЕСПЕЧЕНИЯ ТАКТОВОЙ<BR>СЕТЕВОЙ
СИНХРОНИЗАЦИИ</B></FONT></FONT></FONT></P>
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>1. Блок
сетевой синхронизации средства связи,
выполняющего функции системы коммутации
(БСС) - генераторное оборудование,
обеспечивающее выбор сигнала синхронизации
из сигналов, которые могут использоваться
для тактовой синхронизации средств
связи, выполняющих функции систем
коммутации, восстановление характеристик
выбранного сигнала и синхронизацию
этим сигналом указанного средства
связи, а также формирование выходного
сигнала синхронизации, предназначенного
для синхронизации других средств связи
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>20.
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>21.
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>22.
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>23. Сеть
тактовой сетевой синхронизации (сеть
ТСС) [Network timing Synchronization] - элемент системы
ТСС, который определяет направления,
разрешенные для приема сигналов
синхронизации средствами связи. Сеть
ТСС состоит из линий связи, по которым
распределяются сигналы синхронизации,
и технических средств ТСС, восстанавливающих
параметры сигналов синхронизации,
искаженных при их распространении по
линиям связи, а также формирующих
необходимое количество сигналов
синхронизации для их распределения
между средствами связи.</FONT></FONT></FONT></P>
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>24.
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>33. Цикл
[Cycle] - наименьший интервал времени,
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>34.
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>4. В
случае использования сигналов
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>5. Для
целей синхронизации частоты в сетях с
пакетной коммутацией могут использоваться
...
<P STYLE="margin-bottom: 0.14in; background: #ffffff; line-height: 100%">
<FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>7. При
использовании потоков STM-N и GE для
...
<TABLE WIDTH=4369 CELLPADDING=0 CELLSPACING=0 BGCOLOR="#ffffff">
	...
	<COL WIDTH=2386>
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>МОВИ
			(нс)</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>интервал
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>250</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,1
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>100<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 79" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>2,5
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>2000</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>433<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 74" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0>0,2
		...
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 72" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0><FONT COLOR="#222222">&nbsp;<FONT FACE="Arial, serif"><FONT SIZE=3>&gt;
			2 000</FONT></FONT></FONT></P>
		</TD>
	</TR>
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>ДВИ
			(нс)</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>интервал
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>12</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,1
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,7<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 68" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>17,14
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>58
...
<TABLE WIDTH=4369 CELLPADDING=0 CELLSPACING=0 BGCOLOR="#ffffff">
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>25</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,1
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>10<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 58" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>2,5
	...
	<TR VALIGN=BOTTOM>
		...
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>200
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>433<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 53" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0>0,2
		...
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 51" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0><FONT COLOR="#222222">&nbsp;<FONT FACE="Arial, serif"><FONT SIZE=3>&gt;
			2 000</FONT></FONT></FONT></P>
		</TD>
	</TR>
	<TR VALIGN=BOTTOM>
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>3</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,1
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,7<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 47" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>4,3
...
<TABLE WIDTH=4369 CELLPADDING=0 CELLSPACING=0 BGCOLOR="#ffffff">
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>732</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,1
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>100<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 37" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>7,3
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>433<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 32" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0>0,2
		...
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 30" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0><FONT COLOR="#222222">&nbsp;<FONT FACE="Arial, serif"><FONT SIZE=3>&gt;
			2 000</FONT></FONT></FONT></P>
		</TD>
	</TR>
	<TR VALIGN=BOTTOM>
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>34</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,1
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1983 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,7<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 26" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2386 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>48
...
<TABLE WIDTH=4369 CELLPADDING=0 CELLSPACING=0 BGCOLOR="#ffffff">
	...
	<COL WIDTH=2848>
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1521 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>МОВИ
			(нс)</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2848 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>интервал
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1521 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,3<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 16" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2848 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>83
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1521 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>300</FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2848 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>1000
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1521 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,01<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 11" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2848 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 10" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0><FONT COLOR="#222222">&nbsp;<FONT FACE="Arial, serif"><FONT SIZE=3>&gt;
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1521 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>0,03<IMG SRC="979a0d7261a7158e652ff7815476c235_html_b6db777a.png" NAME="Рисунок 6" ALIGN=BOTTOM WIDTH=12 HEIGHT=15 BORDER=0></FONT></FONT></FONT></P>
		</TD>
		<TD WIDTH=2848 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>100
	...
	<TR VALIGN=BOTTOM>
		<TD WIDTH=1521 BGCOLOR="#ffffff" STYLE="border: none; padding: 0in">
			<P><FONT COLOR="#222222"><FONT FACE="Arial, serif"><FONT SIZE=3>29,7
