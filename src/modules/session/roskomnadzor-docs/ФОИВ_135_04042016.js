...
N 19, ст. 2302; N 26, ст. 3366, ст. 3377; N 30, ст. 4229, ст.
4273; N 49, ст. 6928; 2015, N 29, ст. 4342, ст. 4383, ст.
...
услуг сторонних организаций (далее -
Требования) направлены на регулирование
деятельности обслуживающего персонала
оператора связи или привлекаемых лиц
по изменению маршрутизации трафика на
сети связи, контролю и поддержанию
показателей функционирования сетей
связи в соответствии с нормативно-техническими
документами и технической документацией
на используемые средства связи, в том
числе пусконаладочных работ, технической
поддержки и сервисного обслуживания
средств связи, сбора и анализа
статистических данных, ликвидации
...
с настоящими Требованиями отнесены
работы и услуги, в процессе выполнения
или оказания которых лицам, не являющимся
работниками оператора связи, предоставляется
непосредственный или удаленный доступ
к оборудованию связи для его наладки,
конфигурации, изменения или сброса
...
связи, сторонняя организация (далее -
исполнитель) обязана ежеквартально, не
позднее 10-го числа месяца, следующего
за отчетным кварталом, представлять
оператору связи сведения об иностранных
организациях и иностранных гражданах
...
сеть связи, имеющиеся сведения об
иностранных организациях и иностранных
...
месяц, год), срок действия свидетельства
(число, месяц, год) или разрешения на
открытие представительства (номер,
...
или на бумажном носителе при отсутствии
