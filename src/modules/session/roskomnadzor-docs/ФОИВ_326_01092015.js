...
30, ст. 4229, ст. 4273; 2015, N 29, ст. 4342, ст. 4383),
...
1502; N 26, ст. 3350; N 31, ст. 4251; 2011, N 3, ст. 542; N 14,
ст. 1935; N 21, ст. 2965; N 44, ст. 6272; N 49, ст. 7283;
2012, N 20, ст. 2540; N 39, ст. 5270; N 46, ст. 6347; 2013, N
...
Федерации и осуществляющего эфирную
...
(далее - оператор, осуществляющий эфирную
наземную трансляцию), и операторов
обязательных общедоступных телеканалов
и (или) радиоканалов, осуществляющих
...
сети связи оператора обязательных
общедоступных каналов предоставляет
...
эфирную наземную трансляцию, определяется
...
связи, введенных в установленном порядке
в эксплуатацию средств связи сети связи
цифровой эфирной наземной трансляции
обязательных общедоступных телеканалов
и (или) радиоканалов оператора,
...
связи для установки дополнительного
оборудования и обустройства кабельного
ввода, где размещаются средства связи
...
средств приема сигнала оператор
...
присоединяемой сети связи, количества
абонентов, обслуживаемых посредством
данной сети связи, а также следующие
...
средств приема сигнала либо заключения
об отсутствии технической возможности
приема сигнала обязательных общедоступных
телеканалов и (или) радиоканалов путем
присоединения к сети связи оператора
связи, указанного в пункте 2 статьи 19.2
Федерального закона &quot;О связи&quot;, а
...
каналов определить местонахождение
источника сигнала или точки присоединения
сетей связи, отличной от точки присоединения
сетей связи, определенной оператором,
осуществляющим эфирную наземную
трансляцию, в целях резервирования на
период планово-профилактических и (или)
...
связи, указанных в подпункте &quot;а&quot;
пункта 3 настоящего приказа, обязан
передать сигналы таких телеканалов,
содержащих вставки регионального и/или
местного наполнения, в присоединяемую
сеть связи оператора обязательных
общедоступных каналов при условии
наличия у вещателя такого сигнала в
цифровом формате установленного
качества, сформированного и доведенного
вещателем оператору, осуществляющему
эфирную наземную трансляцию на основании
договора об оказании данной услуги,
...
должны обеспечить распространение
согласованных с вещателем временных
