...
835) и пунктов 4, 6, 11 Правил взаимодействия
...
порядке внедрения системы технических
средств по обеспечению оперативно-розыскных
мероприятий на сетях телефонной,
подвижной и беспроводной связи и
персонального радиовызова общего
пользования&quot; (зарегистрирован в
...
соответствии с перечнем лицензионных
условий осуществления деятельности в
области оказания услуг связи не
предусмотрено обеспечение реализации
...
оперативно-разыскную деятельность
(далее - уполномоченный орган), информации
об абонентских номерах и (или) кодах
идентификации, которые были использованы
...
в том виде, в котором эта информация
передается в сеть связи оператора связи
...
изменения абонентского номера или кода
идентификации, за исключением сетей
связи, в которых не предусмотрена
соответствующим стандартом технологическая
возможность определения местонахождения
пользовательского (оконечного)
оборудования, обеспечивают возможность
...
к информации, передаваемой по каналам
...
абонентский номер и (или) код идентификации
которого указан в запросе пункта
управления ОРМ, а также об абонентском
номере и (или) коде идентификации
...
данных систем расчета за оказанные
услуги связи) обеспечивается возможность
получения информации об оказанных
услугах связи по абонентскому номеру
...
оперативно-разыскных мероприятий, а
...
оператор связи на основании обращения
взаимодействующего подразделения
предоставляет ему технологическое
...
требованиям, предъявляемым к эксплуатации
...
технических средств ОРМ уполномоченного
органа к средствам связи оператора
...
взаимодействующего с оператором связи
