...
Евразийском экономическом союзе и
определяет принципы осуществления
государствами-членами согласованной
политики в области обеспечения единства
измерений в целях обеспечения
сопоставимости результатов измерений
и результатов оценки (подтверждения)
...
выражены в допущенных к применению в
...
между значением величины, полученным
с помощью средства измерений, и значением
величины, воспроизведенной эталоном
...
мерам и весам, основанная на Международной
системе величин и включающая в себя
...
результат может быть соотнесен с
...
или хозяйственной деятельности в
...
получения результатов измерений, которые
могут быть применены для оценки
правильности измеренных значений
величины, полученных с помощью других
методик (методов) измерений величин
...
измерений и метрологической
прослеживаемостью, достаточно однородный
и стабильный в отношении определенных
свойств для того, чтобы использовать
...
единства измерений о разрешении
...
государства-члена в области обеспечения
единства измерений о разрешении
применения стандартного образца
утвержденного типа на территории
государства-члена на основании
положительных результатов испытаний;</FONT></FONT></FONT></FONT></P>
<P CLASS="western" ALIGN=JUSTIFY STYLE="text-indent: 0.38in; margin-bottom: 0in; line-height: 100%">
...
измерений посредством гармонизации
...
и аттестованных методик (методов)
измерений, для которых государствами-членами
обеспечивается метрологическая
прослеживаемость получаемых с их помощью
результатов к Международной системе
...
законодательства государств-членов в
области обеспечения единства измерений
в отношении установления требований к
измерениям, единицам величин, эталонам
единиц величин и шкалам величин, средствам
измерений, стандартным образцам,
методикам (методам) измерений на основе
...
выполненных органами государственной
власти (управления) или юридическими
лицами государств-членов, уполномоченными
(нотифицированными) в соответствии с
законодательством своего государства
на выполнение работ в области обеспечения
единства измерений, согласно утвержденным
...
образцов государств-членов к национальным
(первичным) эталонам и Международной
системе единиц (СИ) государства-члены
организуют проведение работ по созданию
и совершенствованию эталонов единиц
величин, определению и разработке
номенклатуры стандартных образцов,
...
средства измерений в регулируемых
государствами-членами областях, сведения
об эталонах единиц величин и шкалах
величин, утвержденных типах стандартных
образцов и утвержденных типах средств
...
государств-членов, взаимное предоставление
содержащихся в информационных фондах
сведений организуется органами
государственной власти (управления)
государств-членов, указанными в </FONT></FONT><FONT COLOR="#0000ff"><FONT FACE="Times New Roman, serif"><FONT SIZE=3><U>пункте
...
власти (управления) в области обеспечения
единства измерений, которые проводят
консультации, направленные на согласование
